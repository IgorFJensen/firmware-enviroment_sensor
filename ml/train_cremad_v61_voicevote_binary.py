...
MODEL_PATH = (
    BUILD
    / "cremad_model_v61_voicevote_binary.keras"
)

THRESHOLD_PATH = (
    BUILD
    / "cremad_v61_threshold.json"
)

REPORT_PATH = (
    BUILD
    / "cremad_v61_report.json"
)

SPLIT_PATH = (
    BUILD
    / "cremad_v61_split.json"
)
...
# AUGMENTATION
#
# V6.1: augmentations leves no áudio e no Log-Mel.
# ============================================================
...
#
# V6.1 preserva todos os dados. Cada classe tem o mesmo peso
...
print("TRAIN V6.1: todos os segmentos foram preservados.")
...
callbacks = [
    ...
    tf.keras.callbacks.ModelCheckpoint(
        ...
        filepath=str(
            BUILD
            /
            "cremad_model_v61_voicevote_best.keras"
        ),
...
for threshold in np.arange(
    ...
    # V6.1 escolhe o melhor equilíbrio entre detectar risco
...
print(
    "THRESHOLD V6.1 - MELHOR BALANCED ACCURACY"
)
...
print("RESULTADO V6.1 - TEST POR CLIP")
